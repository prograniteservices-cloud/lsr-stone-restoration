...
const HeroSection = () => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-black text-white px-6">
      ...
      >
        <source src="/granite-bg.mp4" type="video/mp4" />
      </video>
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto text-center">
        <div className="mb-20">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-3 mt-10">
            <input 
              ...
              className="p-4 bg-zinc-900/80 border border-zinc-800 text-white w-full md:w-64 outline-none rounded backdrop-blur-sm"
            />
            <button 
              type="button"
        ...
        <div id="calculator" className="max-w-xl mx-auto bg-zinc-900/90 p-8 rounded-2xl border border-zinc-800 shadow-2xl backdrop-blur-md">
